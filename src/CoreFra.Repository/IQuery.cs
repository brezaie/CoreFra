...
namespace CoreFra.Repository
{
    public interface IQuery<TEntity> where TEntity : class
    {
        ...
        Task<IEnumerable<TEntity>> SelectAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<IEnumerable<TEntity>> SelectSqlAsync(string sql, object[] parameters, CancellationToken cancellationToken = default(CancellationToken));
